...
const Section3DAccent = dynamic(() => import('./hero/Section3DAccent'), {
  ssr: false,
});
...
const ProjectsSection = () => {
  ...
  return (
    <section id="projects" className="relative overflow-hidden scroll-mt-20 py-20 bg-gradient-to-br from-slate-900/50 via-purple-900/20 to-slate-900/50">
        ...
        <div className="grid lg:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              ...
              className="group cursor-pointer bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-8 hover:bg-white/10 transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl"
            >
